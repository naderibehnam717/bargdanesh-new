...
export default function ChemistryPage() {
  const files = allFiles.filter((f) => f.category === "شیمی");

  return (
    <>
      <section className="subject-hero" data-subject="chemistry">
        <div className="container">
          <h1 className="subject-hero__title" data-text="CHEMISTRY">
            CHEMISTRY
          </h1>
          <p className="subject-hero__subtitle">شیمی</p>
        </div>
      </section>
      ...
      <main className="section">
        <div className="container">
          <div className="subject-intro">
            <h2 className="subject-intro__title">📖 درباره‌ی شیمی</h2>
            <p className="subject-intro__text">
              شیمی علم مطالعه‌ی ماده، خواص آن، ساختار اتم‌ها و مولکول‌ها و واکنش‌های
              بین آن‌هاست. این علم پایه‌ی بسیاری از علوم دیگر مانند زیست‌شناسی، پزشکی،
              داروسازی، مهندسی مواد و زمین‌شناسی محسوب می‌شود.
            </p>
            <p className="subject-intro__text">
              در این بخش، جزوه‌های اختصاصی برگ دانش در زمینه‌های مختلف شیمی در اختیار
          ...
          <div className="layout-with-sidebar">
            <div>
              <div className="section__header" style={{ textAlign: "right", marginLeft: 0, maxWidth: "100%" }}>
                <h2 className="section__title">📚 جزوه‌های شیمی</h2>
